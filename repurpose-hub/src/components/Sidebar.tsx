...
const Sidebar = () => {
  ...
  if (user?.role === "admin") {
    navItems.push({ label: "Admin", icon: Settings, path: "/home/admin" });
  }
          ...
          <div className={cn(
            ...
            {isSidebarOpen ? (
              <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Button 
                    variant="outline" 
                    size="sm" 
                    className="h-8 rounded-lg text-xs gap-1.5 border-slate-200"
                  ...
                  <Button 
                    variant="ghost" 
                    size="sm" 
                    className="h-8 rounded-lg text-xs gap-1.5 text-rose-600 hover:text-rose-700 hover:bg-rose-50 border-transparent"
              ...
              <div className="group relative flex flex-col items-center gap-4">
                <div 
                  className="p-1 rounded-xl hover:bg-slate-100 transition-all cursor-pointer"
                  onClick={() => navigate("/home/profile")}
                >
