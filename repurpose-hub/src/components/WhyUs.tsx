    ...
    <section className="py-32" id="why-us">
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center px-5 py-16 md:px-10 md:py-20">
        ...
        <p className="font-inter mx-auto mb-12 mt-4 max-w-lg px-5 text-center text-base font-light text-gray-500">
          Transform your waste into valuable resources with Repurpose Hub. Follow these simple steps to get started on your sustainable journey!        </p>
        {/* HOW IT WORKS STEPS */}
        <div className="flex flex-col items-start justify-center lg:flex-row">
          ...
          <div className="relative my-8 flex w-full rounded-md lg:mx-8 lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0">
              <h2 className="mb-5 text-xl font-medium lg:mt-8">
                Explore Materials              </h2>
              <p className="font-inter max-w-md pr-5 text-base text-gray-500">
                Discover a variety of materials available for repurposing. From everyday items to unique finds, we have everything you need to spark your creativity.              </p>
            </div>
          ...
          <div className="relative my-8 flex w-full rounded-md lg:mx-8 lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0">
              ...
              <p className="font-inter max-w-md pr-5 text-base text-gray-500">
                ...
                Browse our project ideas and tutorials to find inspiration for your next repurposing project. Whether you’re a beginner or a seasoned DIYer, we’ve got something for everyone!
          ...
          <div className="relative my-8 flex w-full rounded-md lg:mx-8 lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0">
              <h2 className="mb-5 text-xl font-medium lg:mt-8">Create {'&'} Share</h2>
              <p className="font-inter max-w-md pr-5 text-base text-gray-500">
                Bring your ideas to life! After completing your project, share your creations with our community. Together, we can celebrate innovation and sustainability.              </p>
            </div>
          </div>
        </div>
      </div>
